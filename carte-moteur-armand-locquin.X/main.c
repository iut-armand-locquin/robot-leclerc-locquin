...
void SetNextRobotStateInAutomaticMode(void) {
    ...
    if (robotState.distanceTelemetreDroit < 22 &&
            robotState.distanceTelemetreCentre > 17 &&
    ...
    else if (robotState.distanceTelemetreCentre < 14 &&
            robotState.distanceTelemetreDroit < 18) //Obstacle en face à droite
        positionObstacle = OBSTACLE_EN_FACE_A_DROITE;
    else if (robotState.distanceTelemetreCentre < 14 &&
            robotState.distanceTelemetreGauche < 18) //Obstacle en face à gauche
        positionObstacle = OBSTACLE_EN_FACE_A_GAUCHE;
    else if (robotState.distanceTelemetreDroit > 22 &&
            robotState.distanceTelemetreCentre > 17 &&
            robotState.distanceTelemetreGauche > 22) //Pas d'obstacle
        positionObstacle = PAS_D_OBSTACLE;
    else if (robotState.distanceTelemetreDroit < 22 &&
            robotState.distanceTelemetreCentre < 17 &&
            robotState.distanceTelemetreGauche > 22) //Obstacle en face et à droite
        positionObstacle = OBSTACLE_EN_FACE_ET_A_DROITE;
    else if (robotState.distanceTelemetreDroit > 22 &&
            robotState.distanceTelemetreCentre < 17 &&
            robotState.distanceTelemetreGauche < 22) //Obstacle en face et à gauche
    ...
    else if (positionObstacle == OBSTACLE_EN_FACE_A_DROITE)
        nextStateRobot = STATE_TOURNE_SUR_PLACE_DROITE;
    else if (positionObstacle == OBSTACLE_EN_FACE_A_GAUCHE)
